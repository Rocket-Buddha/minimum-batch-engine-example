 ...
 */
class MyStep2 extends BatchStep {
  ...
  async step(previousStepPayloadAcc) {
    ...
    return new Promise((resolve, reject) => {
      ...
      setTimeout(() => {
        ...
        /**
         * This algorithm will accumulate the payloads,
         * joining the results in this way: "accPayload1**accPayload2-accPayload3..."
         */
        let acc =  "";
